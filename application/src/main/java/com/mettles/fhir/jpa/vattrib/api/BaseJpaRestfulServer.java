...
import com.mettles.fhir.jpa.vattrib.CustomBulkImportProvider;
import com.mettles.fhir.jpa.vattrib.IRepositoryValidationInterceptorFactory;
...
public class BaseJpaRestfulServer extends RestfulServer {
  ...
  @Autowired
  CustomBulkImportProvider customBulkImportProvider;
  @Autowired
  ...
  protected void initialize() throws ServletException {
    ...
    if (appProperties.getBulk_import_enabled()) {
      registerProvider(customBulkImportProvider);
    }
